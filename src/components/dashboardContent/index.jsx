...
const DashboardContent = () => {
  const summaryData = [
    ...
    {
      title: "Arrecadação Semestral",
      value: "R$ 1.987.650,00",
      change: "+12% em relação ao semestre anterior",
      isPositive: true,
    },
    {
      title: "Ocupação Média",
      value: "78%",
      change: "-3% em relação à semana anterior",
      isPositive: false,
    },
  ];
  ...
  const sessions = [
    {
      time: "14:30",
      movie: "Aventuras Intergaláticas",
      room: "Sala 1",
      capacity: "87% vendido",
    },
    {
      time: "15:00",
      movie: "O Mistério do Vale",
      room: "Sala 2",
      capacity: "65% vendido",
    },
    {
